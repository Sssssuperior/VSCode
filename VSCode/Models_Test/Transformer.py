...
class token_Transformer(nn.Module):
    ...
    def forward(self, rgb_fea, task, num):
        B, _, _ = rgb_fea.shape
        ...
        return fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_tmp, contour_tokens_tmp, saliency_fea_1_16, contour_fea_1_16, task_prompt
