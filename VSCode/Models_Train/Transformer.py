...
class token_Transformer(nn.Module):
    ...
    def forward(self, rgb_fea, num):
        ...
        task_prompt = torch.cat((task_prompt1, task_prompt2), dim=0)
        ...
        return fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_tmp, contour_tokens_tmp, saliency_fea_1_16, contour_fea_1_16, task_prompt, task_prompt_total
