...
class ImageDepthNet(nn.Module):
    ...
    def forward(self, image_Input, depth_Input):
        ...
        # VST Decoder
        fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_tmp, contour_tokens_tmp, saliency_fea_1_16, contour_fea_1_16, task_prompt, task_prompt_total1 = self.token_trans(rgb_fea_1_16, self.num_deco)
