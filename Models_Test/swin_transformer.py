...
class SwinTransformer(nn.Module):
    ...
    def forward_features(self, x, task_prompt, num, domain_prompt):
        x = self.patch_embed(x)
        if self.ape:
            x = x + self.absolute_pos_embed
        x = self.pos_drop(x)
        
        x_1_4, x_1_8 = self.layers[0](x, task_prompt[0], num[0], domain_prompt[0])
        x_1_8, x_1_16 = self.layers[1](x_1_8, task_prompt[1], num[1], domain_prompt[1])
        x_1_16, x_1_32 = self.layers[2](x_1_16, task_prompt[2], num[2], domain_prompt[2])
        x_1_32 = self.layers[3](x_1_32, task_prompt[3], num[3], domain_prompt[3])
    ...
    def forward(self, x, task_prompt, num, domain_prompt):
        x_1_4, x_1_8, x_1_16, x_1_32 = self.forward_features(x, task_prompt, num, domain_prompt)
        x = self.head(x_1_32)
        return x_1_4, x_1_8, x_1_16, x_1_32
