...
if __name__ == "__main__":
    ...
    parser.add_argument('--RGBdata_root', default='./Data/RGB/Train/', type=str, help='rgbdata path')
    parser.add_argument('--RGBDdata_root', default='./Data/RGBD/Train/', type=str, help='rgbddata path')
    parser.add_argument('--RGBTdata_root', default='./Data/RGBT/Train/',type=str, help='rgbtdata path')
    parser.add_argument('--RGBVdata_root', default='./Data/RGBV/Train/',type=str, help='rgbvdata path')
    ...
    parser.add_argument('--pseudodata_root', default='./Data/pseudo/', type=str, help='codrgbvdata path')
    ...
    parser.add_argument('--RGBtrainset', default='DUTS/DUTS-TR+RGB_new_pseudo', type=str, help='Trainging set')
    parser.add_argument('--RGBDtrainset', default='NJUD+NLPR+DUTLF-Depth+RGBD_new_pseudo', type=str, help='Trainging set')
    parser.add_argument('--RGBTtrainset', default='VT5000+RGBT_new_pseudo', type=str, help='Trainging set')
    parser.add_argument('--RGBVtrainset', default='DAVIS+DAVSOD+VSOD_new_pseudo', type=str, help='Trainging set')
    parser.add_argument('--CODRGBtrainset', default='COD10K+CAMO+CODRGB_new_pseudo', type=str, help='Trainging set')
    parser.add_argument('--CODRGBVtrainset', default='MoCA_Mask+CODRGBV_new_pseudo', type=str, help='Trainging set')
    ...
    #parser.add_argument('--RGBDprob', default=0.33, type=int, help='save model path')
    #parser.add_argument('--RGBTprob', default=0.66, type=int, help='save model path')
    ...
    parser.add_argument('--RGBVtest_paths', type=str, default='DAVIS16+ViSal+DAVSOD-easy-30+DAVSOD-Normal-25+FBMS+SegV2')
