...
class token_Transformer(nn.Module):
    ...
    def forward(self, rgb_fea, task):
        ...
        if task == "CODRGB" or task == "CODRGBV" or task == "CODRGBD":
            task_prompt = self.task_promptCOD_token.expand(B, -1, -1)
        else:
            task_prompt = self.task_promptSOD_token.expand(B, -1, -1)
        fea_1_16 = torch.cat((task_prompt, fea_1_16), dim=1)
        # sal task fea con
        ...
        return fea_1_16, saliency_tokens, contour_tokens, fea_16, saliency_tokens_tmp, contour_tokens_tmp, saliency_fea_1_16, contour_fea_1_16, task_prompt, num, task_prompt_total
