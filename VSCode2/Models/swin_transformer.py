    ...
    def forward_features(self, rgb, depth, domain_prompt, task_prompt, num,
        ...
        for i in range(4):
            ...
            for k2 in range(B):
                ...
                prompt2 = topk_values_t[k2,:,0].repeat(1,1,num[i]).flatten(1)
            ...
            rgb_prompt_d.append(domain_prompt_specific)
            rgb_prompt_t.append(task_prompt_specific)
            ...
            if depth != None:
                ...
                domain_prompt_d.append(domain_prompt_specific)
                domain_prompt_t.append(task_prompt_specific)
                output_depth.append(save)

        return output_rgb, output_depth, rgb_prompt_d, rgb_prompt_t, domain_prompt_d, domain_prompt_t

    def forward(self, rgb, depth, domain_prompt, task_prompt, num,
                                                   gate_domain, gate_task, expert_domain, expert_task):
        output_rgb, output_depth, rgb_prompt_d, rgb_prompt_t, domain_prompt_d, domain_prompt_t = self.forward_features(rgb, depth, domain_prompt, task_prompt, num,
                                                   gate_domain, gate_task, expert_domain, expert_task)
        return output_rgb, output_depth, rgb_prompt_d, rgb_prompt_t, domain_prompt_d, domain_prompt_t
